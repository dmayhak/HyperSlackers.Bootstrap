...
namespace HyperSlackers.Bootstrap.BootstrapMethods
{
    public partial class Bootstrap<TModel>
    {
        public FileControl<TModel> File(string htmlFieldName)
        {
            ...
            return new FileControl<TModel>(html, htmlFieldName, ModelMetadata.FromStringExpression(htmlFieldName, html.ViewData));
        }
        ...
        public FileControl<TModel> FileFor<TValue>(Expression<Func<TModel, TValue>> expression)
        {
            ...
            return new FileControl<TModel>(html, ExpressionHelper.GetExpressionText(expression), ModelMetadata.FromLambdaExpression<TModel, TValue>(expression, html.ViewData));
        }
    }
}